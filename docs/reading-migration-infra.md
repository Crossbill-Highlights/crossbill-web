...
class IHighlightRepository(ABC):
    ...
    def add_many(self, highlights: List[Highlight]) -> List[Highlight]:
        ...
        Args:
            highlights: List of domain entities to persist
...
class IReadingSessionRepository(ABC):
    ...
    def get_by_book(
        ...
        Returns:
            List of reading session entities
        """
        pass
...
```python
"""
Mapper for converting between Highlight domain entities and ORM models.
...
class HighlightMapper:
    ...
    - Reconstitute domain entities from ORM models
    ...
    def update_orm_from_entity(orm: HighlightORM, entity: Highlight) -> None:
        ...
        Used for updating persisted entities.
...
class PostgresHighlightRepository(IHighlightRepository):
    ...
    def add_many(self, highlights: List[Highlight]) -> List[Highlight]:
        ...
        Args:
            highlights: List of domain entities
